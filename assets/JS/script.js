...
function contact() {
  window.location.href = "https://wa.me/qr/YUVTPV77S5AMM1";
};
...
`;
  ...
  Email.send({
    Host: "miltomy01@gmail.com",
    Username: "miltomy01@gmail.com",
    Password: "3B90AA843D8DCA9333F0808C684A7F36C4F9",
    To: 'miltomy01@gmail.com',
    From: "miltomy01@gmail.com",
...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "Portfolio | Robert Babilda";
  } else {
